  ...
  RIGHT_MOUSE_BUTTON = 3;
    ...
    Spine.DropdownController = (function(_super) {
      ...
      function DropdownController() {
        ...
        $(window).bind('click', this.window_clicked);
        $(window).bind('contextmenu', this.window_clicked);
      }
      ...
      DropdownController.prototype.show = function(e) {
        ...
        this.is_open = true;
        return Spine.DropdownController.open = this;
      };

      DropdownController.prototype.window_clicked = function(e) {
        if (e.which !== RIGHT_MOUSE_BUTTON || e.which === RIGHT_MOUSE_BUTTON && Spine.DropdownController.open !== this) {
          return this.hide();
        }
      };
