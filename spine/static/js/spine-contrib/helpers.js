  ...
  ENTER = 13;
    ...
    Spine.ItemController = (function(_super) {
      ...
      function ItemController() {
        ...
        _ref = ItemController.__super__.constructor.apply(this, arguments);
        return _ref;
      }
    ...
    Spine.ModalController = (function(_super) {
      ...
      ModalController.prototype.show = function(options) {
        ...
        if ((_ref1 = this.body_controller) != null) {
          if (typeof _ref1.init_instance === "function") {
            _ref1.init_instance(options);
          }
        }
      ...
      ModalController.prototype.save = function() {
        var _ref1;
        return (_ref1 = this.body_controller) != null ? typeof _ref1.save === "function" ? _ref1.save() : void 0 : void 0;
      };
  ...
  RIGHT_MOUSE_BUTTON = 3;
    ...
    Spine.DropdownController = (function(_super) {
      ...
      function DropdownController() {
        this.hide = __bind(this.hide, this);
        this.show = __bind(this.show, this);
        _ref1 = DropdownController.__super__.constructor.apply(this, arguments);
        return _ref1;
      }
      ...
      DropdownController.hide_open = function(e) {
        ...
        if ((e == null) || (e != null ? e.which : void 0) !== RIGHT_MOUSE_BUTTON) {
          return (_ref2 = Spine.DropdownController.open) != null ? _ref2.hide() : void 0;
        }
      };
  ...
  if ((typeof Spine !== "undefined" && Spine !== null ? Spine.DropdownController : void 0) != null) {
    ...
    Spine.EditionDropdown = (function(_super) {
      ...
      function EditionDropdown() {
        ...
        _ref2 = EditionDropdown.__super__.constructor.apply(this, arguments);
        return _ref2;
      }
      ...
      EditionDropdown.prototype.selected_references = function() {
        var selected, _i, _len, _ref3, _results;
        _ref3 = $(this.selected_items_selector);
        _results = [];
    ...
    Spine.ItemWithContextualMenu = (function(_super) {
      ...
      ItemWithContextualMenu.prototype.refreshElements = function() {
        ...
        if ((_ref4 = this.menu_controller) != null) {
          _ref4.release();
        }
